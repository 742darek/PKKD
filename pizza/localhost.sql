...
--
-- Host: localhost
-- Czas wygenerowania: 12 Kwi 2013, 10:10
...
--
-- Struktura tabeli dla tabeli `kurs_comments`
--

CREATE TABLE IF NOT EXISTS `kurs_comments` (
  ...
  `com_date` int(10) unsigned NOT NULL,
  PRIMARY KEY (`com_id`)
...
--
-- Struktura tabeli dla tabeli `kurs_news`
--

CREATE TABLE IF NOT EXISTS `kurs_news` (
...
--
-- Zrzut danych tabeli `kurs_news`
--

INSERT INTO `kurs_news` (`news_id`, `news_title`, `news_text`, `news_author`, `news_date`, `news_keywords`) VALUES
(1, 'SIemano', 'Co tam', 'Karol', 1364594229, 'siema, czesc');
--
-- Baza danych: `blogtutorial`
--
CREATE DATABASE `blogtutorial` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `blogtutorial`;
...
('def', 'blog', 'kurs_comments', 'com_id', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_comments', 'news_id', 2, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_comments', 'com_title', 3, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_comments', 'com_text', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_comments', 'com_author', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_comments', 'com_date', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_id', 1, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_title', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_text', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_author', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_date', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'blog', 'kurs_news', 'news_keywords', 6, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'posts', 'id', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(8) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'posts', 'title', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'posts', 'body', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'posts', 'user_id', 4, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(8) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'price', 3, NULL, 'NO', 'decimal', NULL, NULL, 13, 2, NULL, NULL, 'decimal(13,2)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'image', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'option_name', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'products', 'option_values', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'produkty', 'nazwa', 1, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'produkty', 'typ', 2, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'produkty', 'cena', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'test', 'username', 1, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'users', 'id', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(8) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'users', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'users', 'email', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'users', 'password', 4, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'blogtutorial', 'users', 'rights', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
...
('def', 'pkkd', 'users', 'id', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(8) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pkkd', 'users', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'pkkd', 'users', 'email', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pkkd', 'users', 'password', 4, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2410'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2151'),
('INNODB_BUFFER_POOL_PAGES_DATA', '276'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '2'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7916'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2456'),
('INNODB_BUFFER_POOL_READS', '277'),
...
('INNODB_DATA_READ', '6721536'),
('INNODB_DATA_READS', '287'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1980'),
('UPTIME_SINCE_FLUSH_STATUS', '1980');
...
('BASEDIR', 'e:/wamp/bin/mysql/mysql5.5.24'),
...
('CHARACTER_SETS_DIR', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\share\\charsets\\'),
('LOG_BIN', 'ON'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\share\\'),
...
('PID_FILE', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\hp.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\hp.log'),
('FLUSH_TIME', '1800'),
...
('PLUGIN_DIR', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'e:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\hp-slow.log'),
...
('def', 'blog', 'PRIMARY', 'def', 'blog', 'kurs_comments', 'com_id', 1, NULL, NULL, NULL, NULL),
('def', 'blog', 'PRIMARY', 'def', 'blog', 'kurs_news', 'news_id', 1, NULL, NULL, NULL, NULL),
('def', 'blogtutorial', 'PRIMARY', 'def', 'blogtutorial', 'posts', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'blogtutorial', 'fk_posts_users', 'def', 'blogtutorial', 'posts', 'user_id', 1, 1, 'blogtutorial', 'users', 'id'),
('def', 'blogtutorial', 'PRIMARY', 'def', 'blogtutorial', 'products', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'blogtutorial', 'PRIMARY', 'def', 'blogtutorial', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'pkkd', 'PRIMARY', 'def', 'pkkd', 'users', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-04-12 10:10:30', '2013-04-12 10:10:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2013-04-12 10:10:30', NULL, NULL, NULL, '', '', NULL),
('def', 'blog', 'kurs_comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-03-29 21:24:54', '2013-03-29 22:24:54', NULL, NULL, '', '', NULL),
('def', 'blog', 'kurs_news', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 48, 48, 281474976710655, 2048, 0, '2013-03-29 21:24:37', '2013-03-29 22:57:10', NULL, NULL, '', '', NULL),
('def', 'blogtutorial', 'posts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 8388608, '2013-04-03 16:55:25', NULL, NULL, NULL, '', '', NULL),
('def', 'blogtutorial', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 8388608, '2013-04-11 20:53:21', NULL, NULL, NULL, '', '', NULL),
('def', 'blogtutorial', 'produkty', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 8388608, '2013-04-11 10:36:08', NULL, NULL, NULL, '', '', NULL),
('def', 'blogtutorial', 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 8388608, '2013-04-04 12:31:41', NULL, NULL, NULL, '', '', NULL),
('def', 'blogtutorial', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 16384, 8388608, '2013-04-11 10:53:47', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, NULL, '', '', NULL),
...
('def', 'pkkd', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2013-04-03 09:00:21', NULL, NULL, NULL, '', '', NULL);
...
(22, 'root', 'localhost:49628', 'blogtutorial', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(4, 'root', 'localhost:49314', 'blogtutorial', 'Sleep', 782, '', NULL),
(3, 'root', 'localhost:49205', 'blogtutorial', 'Sleep', 1908, '', NULL),
(2, 'root', 'localhost:49202', 'blogtutorial', 'Sleep', 1837, '', NULL),
(1, 'root', 'localhost:49199', 'blogtutorial', 'Sleep', 1963, '', NULL);
...
('def', 'blogtutorial', 'fk_posts_users', 'def', 'blogtutorial', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'posts', 'users');
...
('def', 'blog', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'blogtutorial', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'karol', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'pkkd', 'latin1', 'latin1_swedish_ci', NULL),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2314'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2329'),
('INNODB_BUFFER_POOL_PAGES_DATA', '278'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '2'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7914'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2677'),
('INNODB_BUFFER_POOL_READS', '279'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6754304'),
('INNODB_DATA_READS', '289'),
('INNODB_DATA_WRITES', '7'),
('INNODB_DATA_WRITTEN', '35328'),
('INNODB_DBLWR_PAGES_WRITTEN', '1'),
('INNODB_DBLWR_WRITES', '1'),
...
('def', 'blog', 'kurs_comments', 0, 'blog', 'PRIMARY', 1, 'com_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blog', 'kurs_news', 0, 'blog', 'PRIMARY', 1, 'news_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'posts', 0, 'blogtutorial', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'posts', 1, 'blogtutorial', 'fk_posts_user_idx', 1, 'user_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'products', 0, 'blogtutorial', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'users', 0, 'blogtutorial', 'PRIMARY', 1, 'id', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'users', 1, 'blogtutorial', 'login_idx', 1, 'email', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'blogtutorial', 'users', 1, 'blogtutorial', 'login_idx', 2, 'password', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'pkkd', 'users', 0, 'pkkd', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pkkd', 'users', 1, 'pkkd', 'login_idx', 1, 'email', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pkkd', 'users', 1, 'pkkd', 'login_idx', 2, 'password', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-04-12 10:10:31', '2013-04-12 10:10:31', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2013-04-12 10:10:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'blog', 'kurs_comments', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2013-03-29 21:24:54', '2013-03-29 22:24:54', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blog', 'kurs_news', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 48, 48, 281474976710655, 2048, 0, 2, '2013-03-29 21:24:37', '2013-03-29 22:57:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blogtutorial', 'posts', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, 1, '2013-04-03 16:55:25', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blogtutorial', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, 4, '2013-04-11 20:53:21', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blogtutorial', 'produkty', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, NULL, '2013-04-11 10:36:08', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blogtutorial', 'test', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 8388608, NULL, '2013-04-04 12:31:41', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'blogtutorial', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 16384, 8388608, 24, '2013-04-11 10:53:47', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 15:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 15:02:40', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'pkkd', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 8388608, 2, '2013-04-03 09:00:21', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'blog', 'PRIMARY', 'blog', 'kurs_comments', 'PRIMARY KEY'),
('def', 'blog', 'PRIMARY', 'blog', 'kurs_news', 'PRIMARY KEY'),
('def', 'blogtutorial', 'PRIMARY', 'blogtutorial', 'posts', 'PRIMARY KEY'),
('def', 'blogtutorial', 'fk_posts_users', 'blogtutorial', 'posts', 'FOREIGN KEY'),
('def', 'blogtutorial', 'PRIMARY', 'blogtutorial', 'products', 'PRIMARY KEY'),
('def', 'blogtutorial', 'PRIMARY', 'blogtutorial', 'users', 'PRIMARY KEY'),
...
('def', 'pkkd', 'PRIMARY', 'pkkd', 'users', 'PRIMARY KEY');
...
--
-- Zrzut danych tabeli `INNODB_CMP_RESET`
--
...
--
-- Zrzut danych tabeli `INNODB_CMPMEM_RESET`
--
...
--
-- Zrzut danych tabeli `INNODB_CMPMEM`
--
...
--
-- Zrzut danych tabeli `INNODB_CMP`
--
...
-- Baza danych: `karol`
--
CREATE DATABASE `karol` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `karol`;
--
-- Baza danych: `mysql`
--
...
--
-- Struktura tabeli dla tabeli `columns_priv`
--
...
--
-- Struktura tabeli dla tabeli `general_log`
--
...
--
-- Struktura tabeli dla tabeli `help_category`
--
...
--
-- Zrzut danych tabeli `help_category`
--
...
--
-- Struktura tabeli dla tabeli `help_keyword`
--
...
--
-- Zrzut danych tabeli `help_keyword`
--
...
--
-- Struktura tabeli dla tabeli `help_relation`
--
...
--
-- Zrzut danych tabeli `help_relation`
--
...
--
-- Struktura tabeli dla tabeli `help_topic`
--
...
--
-- Zrzut danych tabeli `help_topic`
--
...
--
-- Struktura tabeli dla tabeli `ndb_binlog_index`
--
...
--
-- Struktura tabeli dla tabeli `proc`
--
...
--
-- Struktura tabeli dla tabeli `procs_priv`
--
...
--
-- Struktura tabeli dla tabeli `proxies_priv`
--
...
--
-- Zrzut danych tabeli `proxies_priv`
--
...
--
-- Struktura tabeli dla tabeli `slow_log`
--
...
--
-- Struktura tabeli dla tabeli `tables_priv`
--
...
--
-- Struktura tabeli dla tabeli `time_zone`
--
...
--
-- Struktura tabeli dla tabeli `time_zone_leap_second`
--
...
--
-- Struktura tabeli dla tabeli `time_zone_name`
--
...
--
-- Struktura tabeli dla tabeli `time_zone_transition`
--
...
--
-- Struktura tabeli dla tabeli `time_zone_transition_type`
--
...
--
-- Baza danych: `performance_schema`
--
...
--
-- Struktura tabeli dla tabeli `cond_instances`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_current`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_history`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_history_long`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_summary_by_instance`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Struktura tabeli dla tabeli `events_waits_summary_global_by_event_name`
--
...
--
-- Struktura tabeli dla tabeli `file_instances`
--
...
--
-- Struktura tabeli dla tabeli `file_summary_by_event_name`
--
...
--
-- Struktura tabeli dla tabeli `file_summary_by_instance`
--
...
--
-- Struktura tabeli dla tabeli `mutex_instances`
--
...
--
-- Struktura tabeli dla tabeli `performance_timers`
--
...
--
-- Zrzut danych tabeli `performance_timers`
--
...
--
-- Struktura tabeli dla tabeli `rwlock_instances`
--
...
--
-- Struktura tabeli dla tabeli `setup_consumers`
--
...
--
-- Zrzut danych tabeli `setup_consumers`
--
...
--
-- Struktura tabeli dla tabeli `setup_instruments`
--
...
--
-- Struktura tabeli dla tabeli `setup_timers`
--
...
--
-- Zrzut danych tabeli `setup_timers`
--
...
-- Baza danych: `pkkd`
--
CREATE DATABASE `pkkd` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pkkd`;
...
(1, 'admin', 'admin@admin.dev', 'd033e22ae348aeb5660fc2140aec35850c4da997');
--
-- Baza danych: `test`
--
